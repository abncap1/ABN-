        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <figcaption className="absolute bottom-4 left-4 right-4 text-center text-black dark:text-slate-100 bg-white dark:bg-slate-800/80 px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm border border-white/40 dark:border-white/10">
